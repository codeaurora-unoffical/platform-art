...
const uint64_t MIRGraph::oat_data_flow_attributes_[kMirOpLast] = {
  ...
  // 44 AGET vAA, vBB, vCC
  DF_DA | DF_UB | DF_UC | DF_NULL_CHK_0 | DF_RANGE_CHK_1 | DF_REF_B | DF_CORE_C | DF_LVN | DF_IS_ARRAY,

  // 45 AGET_WIDE vAA, vBB, vCC
  DF_DA | DF_A_WIDE | DF_UB | DF_UC | DF_NULL_CHK_0 | DF_RANGE_CHK_1 | DF_REF_B | DF_CORE_C | DF_LVN | DF_IS_ARRAY,

  // 46 AGET_OBJECT vAA, vBB, vCC
  DF_DA | DF_UB | DF_UC | DF_NULL_CHK_0 | DF_RANGE_CHK_1 | DF_REF_A | DF_REF_B | DF_CORE_C | DF_LVN | DF_IS_ARRAY,
  ...
  // 4B APUT vAA, vBB, vCC
  DF_UA | DF_UB | DF_UC | DF_NULL_CHK_1 | DF_RANGE_CHK_2 | DF_REF_B | DF_CORE_C | DF_LVN | DF_IS_ARRAY,

  // 4C APUT_WIDE vAA, vBB, vCC
  DF_UA | DF_A_WIDE | DF_UB | DF_UC | DF_NULL_CHK_2 | DF_RANGE_CHK_3 | DF_REF_B | DF_CORE_C | DF_LVN | DF_IS_ARRAY,

  // 4D APUT_OBJECT vAA, vBB, vCC
  DF_UA | DF_UB | DF_UC | DF_NULL_CHK_1 | DF_RANGE_CHK_2 | DF_REF_A | DF_REF_B | DF_CORE_C | DF_LVN | DF_IS_ARRAY,
  ...
  DF_FORMAT_35C | DF_NULL_CHK_OUT0 | DF_UMS | DF_IS_INVOKE,
  ...
  DF_FORMAT_35C | DF_UMS | DF_IS_INVOKE,
  ...
  DF_FORMAT_3RC | DF_NULL_CHK_OUT0 | DF_UMS | DF_IS_INVOKE,
  ...
  DF_FORMAT_3RC | DF_UMS | DF_IS_INVOKE,
  ...
  DF_NOP | DF_NULL_CHK_0 | DF_IS_INVOKE,
